...
#limiting vectors to stabilize the simulation or itll fall apart
    ...
    def applyRules(self):
        ...
        #distance threshhold for alignment (not separation)
...
#CREATING A BOID ON LEFT MOUSE CLICK
#cid = fig.canvas.mpl_connect('button_press_evnt', buttonPress)

    def buttonPress(self, event):
        # adding a 'button press' event handler
...
def main():
  ...
  ax = plt.axes(xlim=(0, width), ylim=(0, height))
    #making the plot where the boids will move in ^
